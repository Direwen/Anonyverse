<template>
  <div
    ...
    :class="{
      'flex-col gap-2 h-40 px-1 py-2 rounded-md border-anonysecondary': focusedState,
  ...
  >
    <textarea
      ...
      :class="{'pt-0 w-full overflow-y-scroll cursor-text': focusedState, 'pt-8': !focusedState}"
    ...
    <button
      ...
      :class="{'w-full active:scale-90 rounded-md': focusedState, 'rounded-lg rounded-t-2xl': !focusedState}"
      @click="post"
    >
      Post
    </button>
